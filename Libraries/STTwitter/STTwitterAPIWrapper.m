...
- (void)getSearchTweetsWithQuery:(NSString *)q
    ...
    NSDictionary *d = @{@"q" : q, @"max_id" : maxID};
...
- (void)getUserListWithListID:(NSString *)listID
                 successBlock:(void(^)(NSArray *statuses))successBlock
                   errorBlock:(void(^)(NSError *error))errorBlock {
    [self getTimeline:@"lists/statuses.json" withParameters:@{ @"list_id" : listID } sinceID:nil count:NSNotFound successBlock:successBlock errorBlock:errorBlock];
}
...
- (void)getUserListWithListName:(NSString *)listName
                ownerScreenName:(NSString *)ownerScreenName
                   ...
                   successBlock:(void(^)(NSArray *statuses))successBlock
                     errorBlock:(void(^)(NSError *error))errorBlock {
    [self getTimeline:@"lists/statuses.json" withParameters:@{ @"slug" : listName, @"owner_screen_name" : ownerScreenName } sinceID:nil count:optionalCount successBlock:successBlock errorBlock:errorBlock];
}
